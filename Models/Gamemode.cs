...
namespace Utilla.Models
{
    ...
    {
        /// <summary>
        /// There is no gamemode manager to rely on, this should only be used by the Utilla By ACE mod when preparing modded gamemodes or gamemodes using a unique gamemode manager.
        /// </summary>
        None,
        /// <summary>
